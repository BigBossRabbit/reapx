...
def generate_features(repo):
    ...
    if not features:
        features = [
            ...
            "Automatically generated by ReapX",
...
```bash
# Install from your ReapX tap
hermes skills tap add {github_username}/reapx
hermes skills install {skill_name} --tap {github_username}/reapx
